    ...
    <>
      ...
      <section className="bg-primary">
        <div className="container mx-auto py-[15px]">
          <h1 className="text-[28px] text-[#fff]">Top Talent</h1>
        </div>
      </section>
      {/* end of sub header */}
      ...
      <main className="min-h-[50vh] bg-[#F6F7F8] py-[40px] ">
        <div className="container mx-auto">
          ...
          {/* content */}
          <div className="p-[20px] bg-[#fff] drop-shadow-xl rounded-lg mt-[50px]">
            {/* list */}
            {listData.map((item, key) => (
              <div
                ...
                key={key}
              >
                <div className="col-span-6 md:col-span-5 flex gap-[30px]">
                  <img
                    src={item?.photo}
                    alt="profile"
                    width="100px"
                ...
                <div>
                  <button
                    className="btn-primary btn-lg rounded mr-[50px]"
          ...
          <div className="flex justify-center gap-[10px] mt-[40px]">
            ...
            <button className="bg-[#fff] border-2 border-[#E2E5ED] w-[48px] h-[48px] rounded flex justify-center items-center">
              <img src="/images/icon-chevron-l.svg" alt="icon" />
            </button>
            {/* list */}
            ...
            {/* next */}
            <button className="bg-[#fff] border-2 border-[#E2E5ED] w-[48px] h-[48px] rounded flex justify-center items-center">
              <img src="/images/icon-chevron-r.svg" alt="icon" />
            </button>
          </div>
          {/* end of pagination */}
        </div>
...
export async function getServerSideProps() {
  const requst = await axios.get("http://localhost:3000/api/list-talent");
