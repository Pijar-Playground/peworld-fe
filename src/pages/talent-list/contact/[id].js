...
function ContacPage() {
  return (
    <>
      ...
      <main className="min-h-[60vh] bg-[#F6F7F8] pb-[40px] pt-[50px]">
        <div className="container mx-auto">
          <div className="grid grid-cols-3">
            <div className="w-[90%] h-[600px] p-[30px] bg-[#FFFFFF] rounded-lg drop-shadow-md">
              ...
              <h2 className="text-[22px] mb-[20px]">Skill</h2>
            ...
            <div className="w-[100%] col-span-2 pr-[100px] pl-[50px]">
              ...
              <button className="w-[95%] p-3 rounded-lg bg-[#FBB017] text-[#fff] font-medium mt-[30px]">
                Masuk
              </button>
            </div>
          </div>
